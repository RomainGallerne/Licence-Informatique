...
INSERT INTO PERSONNE VALUES (000034,'MARTIN','YVES','FRANCAIS','19-07-1969');
INSERT INTO PERSONNE VALUES (000035,'MOULIN','ANTONIN','BELGE','31-05-1990');
INSERT INTO PERSONNE VALUES (000036,'CHAUR','PIERROT','SUISSE','25-05-2003');
INSERT INTO PERSONNE VALUES (000037,'BATTANT','OLIVIER','FRANCAIS','11-08-2001');
INSERT INTO PERSONNE VALUES (000038,'PRINCE','MICHEL','FRANCAIS','22-12-1999');
...
INSERT INTO JOUEUR VALUES (000034,NULL,13,000006);
INSERT INTO JOUEUR VALUES (000035,NULL,14,000007);
INSERT INTO JOUEUR VALUES (000036,NULL,15,000008);
INSERT INTO JOUEUR VALUES (000037,NULL,16,000009);
INSERT INTO JOUEUR VALUES (000038,NULL,17,000010);
...
BEGIN
    ...
    END IF;
EXCEPTION
    WHEN ARBITRE THEN RAISE_APPLICATION_ERROR(-20500,'Cet arbitre est deja assigne a un match ce jour.');
END;
/
...
BEGIN
    ...
    END IF;
EXCEPTION
    WHEN EQUIPES THEN RAISE_APPLICATION_ERROR(-20501,'Une equipe ne peut pas jouer contre elle-meme.');
END;
/
...
BEGIN
  ...
  END IF;
EXCEPTION
    WHEN JOUEUR THEN RAISE_APPLICATION_ERROR(-20502,'Ce joueur participe deja a une meme competition dans une autre equipe.');
END;
/
...
END;
/
--procedure qui permet d'afficher l'equipe qui a le plus de victoires
SET SERVEROUTPUT ON
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('L equipe qui a le plus de victoires est l equipe ' || num_equipe || ' avec '|| nb_victoire || ' victoires.');
EXCEPTION
    WHEN NO_DATA_FOUND THEN DBMS_OUTPUT.PUT_LINE('Il n y a aucune equipe avec des victoires dans la base de donnees.');
    WHEN TOO_MANY_ROWS THEN FOR i IN c_equipe
    LOOP
        DBMS_OUTPUT.PUT_LINE('L equipe ' || i.NUM_EQUIPE || ' avec ' || nb_victoire || ' victoires.');
    END LOOP;
END;
/
